...
public class RoomParametersFetcher {
  ...
  private static final int TURN_HTTP_TIMEOUT_MS = 50000;
  ...
  private List<PeerConnection.IceServer> requestTurnServers(String url)
    ...
    //HttpURLConnection connection = new AsyncHttpURLConnection();
    connection.setDoOutput(true);
    connection.setRequestProperty("REFERER", "https://apprtc.xiaominfc.com");
